...
const devs = ['424134723716120578','552983642247528448'];
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['b!help','Type b!help'];
    var i = -1;
    var j = 0;
...
client.on('message', message => {
    ...
    translate(finalToTrans, {to: language}).then(res => {
            message.channel.send({embed: {
                color: 3447003,
                author: {
                  name: 'Shift Community \'s translator',
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=561134931900891137&permissions=8&scope=bot')
  .setDescription(`**
  New Server Add  ShiftsCommunity?
...
client.on('guildDelete', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=561134931900891137&permissions=8&scope=bot')
  .setDescription(`**
  Server Kicked ShiftsCommunity :cry:
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("474127377245667328").sendEmbed(embed)
});
...
client.login("MTA4NzMzNjM0OTczODIwOTMzMA.GXgDua.8peo51hQzcHiXeMBMReRjlqwHs2e8isgkfC7iw")
